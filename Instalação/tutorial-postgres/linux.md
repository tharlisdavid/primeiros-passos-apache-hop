# PostgreSQL com pgAdmin no Linux

### Guia para Pop!_OS, Ubuntu e Debian

Este guia cobre como subir e utilizar o **PostgreSQL** e o **pgAdmin** via Docker Compose, integrado ao ambiente Apache Hop.

> Pré-requisito: Docker e Docker Compose instalados. Consulte o tutorial `tutorial-apache-hop/linux.md` se ainda não tiver.
...
> Se `docker-compose` não funcionar, tente `docker compose up -d postgres pgadmin`.
...
Acesse o banco diretamente pelo container:
...
- Subir o PostgreSQL e pgAdmin via Docker Compose
